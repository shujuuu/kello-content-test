      ...
      *PROGRAMA: ALTERA A SEQUENCIA DO BANCO DO BRASIL (EDA)
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           IF ST-SEQ <> "00"
              MOVE "ERRO ABERTURA SEQBRA6 "  TO CAP002-MENSAGEM-ERRO
