      ...
      *               CALL "GRIDAT1" USING DATA-INV
      *               DISPLAY "6  " DATA-MOVTO-CH10 " " SEQ-CH10
      ...
      *               PERFORM CALL-DIALOG-SYSTEM
                      ...
                      ELSE
                         ...
                         ELSE
                            ...
                            MOVE DATA-VENCTO-CH10 TO DATA-INV
                            CALL "GRIDAT1" USING DATA-INV
                            DISPLAY "7  " DATA-MOVTO-CH10 " " SEQ-CH10
                            MOVE DATA-INV         TO VENC-W
                            PERFORM TESTA-SABADO-DOMINGO

                            DISPLAY "8  " DATA-MOVTO-CH10 " " SEQ-CH10
                            PERFORM TESTA-FERIADO
                            DISPLAY "9  " DATA-MOVTO-CH10 " " SEQ-CH10
                            MOVE DATA-BASE-I TO GRDIAS-AAMMDD-INICIAL
                                                VENC1-WK
                            MOVE VENC-W      TO DATA-INV
                            CALL "GRIDAT2" USING DATA-INV
                            DISPLAY "10  " DATA-MOVTO-CH10 " " SEQ-CH10
                            MOVE DATA-INV    TO GRDIAS-AAMMDD-FINAL
                            CALL "GRDIAS1" USING PARAMETROS-GRDIAS
                            DISPLAY "11  " DATA-MOVTO-CH10 " " SEQ-CH10
       ...
       MOSTRA-CALCULO SECTION.
           ...
           display "qtde-mover = " qtde-mover stop " "
           ...
           display "passei1" stop " "

           IF QTDE-MOVER = 0
           display "passei2" stop " "
              ADD 1                        TO IND
              ...
              ADD 1                        TO QTDE-MOVER
           ELSE
           display "passei3" stop " "
              IF (QTDE-MOVER * 30) <> PM-W
           display "passei4" stop " "
                 ADD 1                     TO IND
                 display "ind = " ind stop " "
                 COMPUTE TAB-DIAS-41i(IND) = PM-W - (QTDE-MOVER * 30)
                 display "TAB-DIAS-41i(IND) = "
                 TAB-DIAS-41i(IND) stop " "
                 MOVE    TAB-DIAS-41i(IND) TO DIAS-TAXA
                 display "dias-taxa = " dias-taxa stop " "
