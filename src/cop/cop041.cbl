      ...
      *    variáveis p/ listar os nomes com iniciais solicitadas
       ...
       01  CAB04.
           ...
           "CONT CUR TU TURNO      FORM L FT MB CK COR-FAIXA  COR-CANUDO
      -    "".
      ...
      *    END-PERFORM.
       ...
       FINALIZA-INICIAL SECTION.
           MOVE GS-AUX-CONTRATO TO NR-CONTRATO-CO40
             ...
             READ COD041 NEXT RECORD AT END MOVE "10" TO ST-COD041
              NOT AT END
                ...
                ELSE
                  ...
                  MOVE TURMA-CO41         TO LINDET-REL(10: 2)
                  MOVE TURNO-CO41         TO LINDET-REL(13:10)
                  MOVE NR-PREV-FORM-CO41  TO LINDET-REL(24: 5)
                  MOVE LISTA-ALUNOS-CO41  TO LINDET-REL(29: 2)
                  MOVE FOTO-TURMA-CO41    TO LINDET-REL(31: 3)
                  MOVE MEDIDA-BECA-CO41   TO LINDET-REL(34: 3)
                  MOVE CHECK-CONVITE-CO41 TO LINDET-REL(37: 3)
                  MOVE COR-FAIXA-CO41     TO LINDET-REL(40: 11)
                  MOVE COR-CANUDO-CO41    TO LINDET-REL(51: 11)
