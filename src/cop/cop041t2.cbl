      ...
      *    MOVE "0000" TO STRING-1(52: 4).
           ...
           OPEN I-O   COD040X COD041 IED011
           CLOSE      COD040X COD041 IED011
           OPEN INPUT COD040X COD041 IED011
           IF ST-COD040X <> "00" OR ST-COD041 <> "00" OR
              ST-IED011  <> "00"
       ...
       CARREGAR-TURMAS SECTION.
           ...
           PERFORM UNTIL ST-COD040X = "10"
              READ COD040X NEXT RECORD AT END
                   MOVE "10" TO ST-COD040X
              NOT AT END
                   IF NR-CONTRATO-CO40X = AUX-CONTRATO
                      ...
                      INITIALIZE REG-COD041
                                 AUX-CURSO
                                 AUX-TURMA
                      MOVE NR-CONTRATO-CO40X TO NR-CONTRATO-CO41
