      ...
      * ------------- IMPRESSÃO INDIVIDUAL ----------------------
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           OPEN INPUT COD060 COD060C COD061 CAD004 COD049

           OPEN INPUT IED011 COD003 CGD010 COD040 COD041 CGD012 PAR001
                      CAD010.
           IF ST-COD060 = "35"
           ...
           move "COP060"            to logacess-programa
      ...
      *    comisao vem do cadastro do contrato
           ...
           MOVE ZEROS       TO CODIGO-CG12(5: 4) GS-CONT-POPUP-FORNEC
           ...
           PERFORM UNTIL ST-COD041 = "10"
             ...
             NOT AT END
                  ...
                  ELSE
                     ...
                     READ COD061 INVALID KEY
                          MOVE 0            TO GS-ESTADO-SELECAO
                     NOT INVALID KEY
                          MOVE 1            TO GS-ESTADO-SELECAO
                     END-READ
      ...
      *-----------------------------------------------------------
       ...
       FINALIZAR-PROGRAMA SECTION.
           CLOSE COD003 COD060 COD061 IED011 CGD010 COD041 CGD012
                 COD040 CAD004 CAD010 COD049 COD060C
