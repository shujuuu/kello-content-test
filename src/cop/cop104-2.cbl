      ...
      *    PAT-FORM-W = patrocinio-wk / QT-FORM-WK-ATUAL
           ...
           05  ALBTRANS-WK          PIC 9999.
           05  ALBVEND-WK           PIC 9999.
           05  FOTTRANS-WK          PIC 9(06).
      ...
      *                      MOVE 1               TO EXECUTADO-WK
                             ...
                             READ RCD100 INVALID KEY
                                  ADD 1               TO ALBTRANS-WK
                                  ADD QT-FOTOS-MTG    TO FOTTRANS-WK
                             NOT INVALID KEY
                                  ADD 1               TO ALBPROD-WK
                                  ADD QT-FOTOS-MTG    TO FOTPROD-WK
                             END-READ
      ...
      *       MOVE PERC-W               TO GS-PERC-FOTO-AVULSA
              ...
              COMPUTE DIVISAO-W ROUNDED= GS-FOTO-DISPON /
                 ((GS-FOTO-PRODUZ + GS-FOTO-EM-TRANSITO) - GS-FOTO-PERD)
              COMPUTE PERC-W ROUNDED= DIVISAO-W * 100
              MOVE PERC-W               TO GS-PERC-FOTO-DISPON

              MOVE 100                  TO GS-PERC-FOTO-DISPON1
              COMPUTE DIVISAO-W ROUNDED= GS-FOTO-VEND /
                                         GS-FOTO-PRODUZ
              COMPUTE PERC-W ROUNDED= DIVISAO-W * 100
              MOVE PERC-W               TO GS-PERC-FOTO-VEND

              COMPUTE DIVISAO-W ROUNDED= GS-FOTO-AVULSA /
                                         GS-FOTO-PRODUZ
              COMPUTE PERC-W ROUNDED= DIVISAO-W * 100
              MOVE PERC-W               TO GS-PERC-FOTO-AVULSA

              COMPUTE DIVISAO-W ROUNDED= GS-FOTO-DEVOL /
                                         GS-FOTO-PRODUZ
              COMPUTE PERC-W ROUNDED= DIVISAO-W * 100
              MOVE PERC-W               TO GS-PERC-FOTO-DEVOL

              COMPUTE DIVISAO-W ROUNDED= GS-FOTO-FOGO /
                                         GS-FOTO-PRODUZ
              COMPUTE PERC-W ROUNDED= DIVISAO-W * 100
              ...
              COMPUTE DIVISAO-W ROUNDED= GS-FOTO-SALDO /
                                         GS-FOTO-PRODUZ
              COMPUTE PERC-W ROUNDED= DIVISAO-W * 100
      ...
      *    2o. LINHA DA LINDET
           ...
           COMPUTE SALALB-W = (ALBPROD-WK + ALBTRANS-WK) - FORMANDOS-WK
           ...
           COMPUTE SALFOT-W = (DISPONIVEL-W + FOTTRANS-WK) - FOTVEND-WK
      ...
      * Poster
           ...
           ADD ALBTRANS-WK           TO GS-ALBUM-EM-TRANSITO
           ...
           ADD FOTTRANS-WK           TO GS-FOTO-EM-TRANSITO
       ...
       ZERA-VARIAVEIS SECTION.
           MOVE ZEROS TO GS-ALBUM-CLIENTE-ATUAL GS-PROD-FOTOG-ATUAL
                         ...
                         GS-FOTO-EM-TRANSITO GS-PERC-FOTO-EM-TRANSITO
