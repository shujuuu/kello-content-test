      ...
      *    EXECUTADO = 1(SIM)    2(NAO)
       ...
       01  VARIAVEIS.
           ...
           05  VALOR-E0              PIC ZZZZ.ZZZ,ZZ BLANK WHEN ZEROS.
      ...
      *    VARIAVEIS P/ CALCULO DE PATROCINIO PAGOS E A PAGAR
           ...
           05  PATROCINIO-PAGO        PIC 9(09)V99   VALUE ZEROS.
           05  PATROCINIO-N-PAGO      PIC 9(09)V99   VALUE ZEROS.

           05  PATROCINIO-PAGO-AEXEC  PIC 9(09)V99   VALUE ZEROS.
           05  PATROCINIO-N-PAGO-AXEC PIC 9(09)V99   VALUE ZEROS.

           05  PATROCINIO-ATUAL       PIC 9(09)V99   VALUE ZEROS.
           05  TOTAL-REPORTAGEM       PIC 9(09)V99   VALUE ZEROS.
      ...
      -    "VOL COMIS FOGO  SALDO   P.M.  VDA.LIQ.IN P/FOTO    V.MED.  D
      -    "VD POSTER".
           ...
           PERFORM UNTIL FS-AUXILIAR = "10"
                 ...
                 NOT AT END
                      ...
                      READ COD040 NOT INVALID KEY
                           ...
                           ELSE
                              MOVE ZEROS TO PATROCINIO-ATUAL
                           END-IF
...
*                          IF USUARIO-W = "ANDER"
*                             DISPLAY "CONTRATO-CO40 = " AT 0501
*                             DISPLAY NR-CONTRATO-CO40   AT 0525
*
*                             DISPLAY "VLR-COMISSAO-CO40 = " AT 0701
*                             MOVE VLR-COMISSAO-CO40 TO MASC-VALOR
*                             DISPLAY MASC-VALOR     AT 0725
*
*                             DISPLAY "PATROCIONIO-ATUAL = " AT 0801
*                             MOVE PATROCINIO-ATUAL  TO MASC-VALOR
*                             DISPLAY MASC-VALOR     AT 0825
*
*                             DISPLAY "TOTAL-REPORTAGEM = " AT 0901
*                             MOVE TOTAL-REPORTAGEM  TO MASC-VALOR
*                             DISPLAY MASC-VALOR     AT 0925
*
*                             STOP " "
*
*                          END-IF
                           ...
                           ADD VLR-COMISSAO-CO40         TO
                               PATROCINIO-WK-ATUAL
                           ADD PATROCINIO-ATUAL          TO
                               PATROCINIO-WK-ATUAL
                           ADD TOTAL-REPORTAGEM          TO
                               PATROCINIO-WK-ATUAL
...
*                             ADD TOTAL-REPORTAGEM          TO
*                                 PATROCINIO-WK-ATUAL
                              ADD PATROCINIO-PAGO-AEXEC     TO
                                  PATROCINIO-PAGO-WK-AEXEC
                              ADD PATROCINIO-N-PAGO-AXEC    TO
                                  PATROCINIO-N-PAGO-WK-AEXEC
                           ELSE
                              IF EXECUTADO-WK = 1
                                 ADD PATROCINIO-PAGO           TO
                                     PATROCINIO-PAGO-WK
                                 ADD PATROCINIO-N-PAGO         TO
                                     PATROCINIO-N-PAGO-WK
                              END-IF
                           END-IF

                           COMPUTE PAT-FORM-WK-ATUAL =
                                                     PATROCINIO-WK-ATUAL
                                                   / QT-FORM-WK-ATUAL
...
*                             PATROCINIO-WK-ATUAL
      ...
      * ---------ROTINAS PERFORMADAS(PELA SEÇÃO MOVER-DADOS-WORK)---
       CALCULAR-DADOS-BRINDE SECTION.
           MOVE ZEROS TO CUSTO-TOTAL
                         ...
                         PATROCINIO-PAGO-AEXEC
                         PATROCINIO-N-PAGO-AXEC
      ...
      * 1 SIM - 2 NÃO
                           ...
                           END-IF
                           ADD CUSTO-W   TO PATROCINIO-N-PAGO
                           ADD CUSTO-W   TO PATROCINIO-N-PAGO-AXEC
                        ELSE
                           MOVE VALOR-PAGO-CO50 TO CUSTO-W
                           ADD CUSTO-W       TO PATROCINIO-PAGO
                           ADD CUSTO-W       TO PATROCINIO-PAGO-AEXEC
                        END-IF


                        add custo-w to patrocinio-atual

                        PERFORM CALCULO-JUROS-BRINDE

                        add juros-w to patrocinio-atual

      *                 display "custo-w          = " at 0101
      *                 move custo-w to masc-valor
      *                 display masc-valor            at 0130
      *                 display "juros-w          = " at 0201
      *                 move juros-w to masc-valor
      *                 display masc-valor            at 0230
      *                 display "patrocinio-atual = " at 0401
      *                 move patrocinio-atual to masc-valor
      *                 display masc-valor            at 0430

      *                 stop " "

                        IF REALIZADO-CO50 <> 1
                           ADD JUROS-W TO PATROCINIO-N-PAGO
                           ADD JUROS-W TO PATROCINIO-N-PAGO-AXEC
                        ELSE
                           ADD JUROS-W TO PATROCINIO-PAGO
                           ADD JUROS-W TO PATROCINIO-PAGO-AEXEC
                        END-IF
      ...
      *--------------------------------------------------------------
      ...
      -    "DA DEVOL COMIS FOGO  SALDO   P.M.  VDA.LIQ.IN P/FOTO    V.ME
      -    "D.  DVD POSTER"   TO GS-LINDET
           MOVE "INSERE-LIST" TO DS-PROCEDURE
           PERFORM CALL-DIALOG-SYSTEM.
           ...
           PERFORM UNTIL ST-WORK = "10"
               ...
               NOT AT END
                    IF GS-EXECUTADO-TRUE AND EXECUTADO-WK = 1 OR
                       GS-AEXECUTAR-TRUE AND EXECUTADO-WK = 2 OR
                       GS-EM-TRANSITO-TRUE AND EXECUTADO-WK = 3
      ...
      *       MOVE PERC-W               TO GS-PERC-FOTO-AVULSA
       ...
       MOVER-DADOS-LINDET SECTION.
           ...
           MOVE OBJ-VENDA-WK-ATUAL      TO VALOR-E0
           MOVE VALOR-E0                TO GS-LINDET(75: 12)
      ...
      *Data Realização
           ...
           MOVE MES-I                   TO GS-LINDET(112: 2)
           MOVE "/"                     TO GS-LINDET(114: 1)
           MOVE ANO-I(3: 2)             TO GS-LINDET(115: 3)
      ...
      * % Venda Liquida
           MOVE VENLIQIND-WK        TO VALOR-E0
           MOVE VALOR-E0            TO GS-LINDET(90: 12)
      ...
      * Preço Médio
           ...
           MOVE VALOR-E3            TO GS-LINDET(103: 5)
      *    dasdasdas
      ...
      * Preço Médio por Cliente
           ...
           MOVE VALOR-E4            TO GS-LINDET(110: 09)
      *    dasdasdas

      * DVD
           MOVE DVD-WK              TO GS-LINDET(119: 5)

      * Poster
           MOVE POSTER-WK           TO GS-LINDET(126: 5)
      ...
      *CONTRATOS NAO EXECUTADOS
       ...
       MOVER-DADOS-RELAT SECTION.
           ...
           MOVE OBJ-VENDA-WK-ATUAL  TO VALOR-E0
           MOVE VALOR-E0             TO LINDET-REL(75: 12)
           MOVE PATROCINIO-WK-ATUAL TO VALOR-E
           MOVE VALOR-E             TO LINDET-REL(90: 11)
           MOVE PAT-FORM-WK-ATUAL   TO VALOR-E1
           MOVE VALOR-E1            TO LINDET-REL(101: 10)
      *Data Realização
           MOVE DATA-WK             TO DATA-I
           MOVE MES-I               TO LINDET-REL(112: 2)
           MOVE "/"                 TO LINDET-REL(114: 1)
           MOVE ANO-I(3: 2)         TO LINDET-REL(115: 3)
      ...
      * Venda Líquida
           MOVE VENLIQIND-WK        TO VALOR-E0
           MOVE VALOR-E0            TO LINDET-REL(90: 12)
      ...
      * Preço Médio
           ...
           END-IF
           MOVE PRECOMED-W          TO VALOR-E3
           MOVE VALOR-E3            TO LINDET-REL(103: 5)
      ...
      * Valor Médio Cliente
           ...
           END-IF
           MOVE VENMEDCLI-W         TO VALOR-E4
           MOVE VALOR-E4            TO LINDET-REL(110: 09)

      * DVD
           MOVE DVD-WK              TO LINDET-REL(119: 5)

      * Poster
           MOVE POSTER-WK           TO LINDET-REL(126: 5)
