      ...
      *    ACCEPT PARAMETROS-W FROM COMMAND-LINE.
           ...
           move "CRP020B"           to logacess-programa
           ...
           ELSE
            ...
            ELSE MOVE GS-LINDET1(33: 8) TO GS-COD-CLIENTE
                 ...
                 EVALUATE CLASSIF-W
                    ...
                    WHEN 1 MOVE "9-Unificado"      TO GS-CLASSIFICACAO
                 END-EVALUATE
      ...
      *    MOVE GS-VALOR-TOTAL             TO VALOR-SALDO-CR20
           ...
           IF GS-VALOR-TOTAL <> GS-VALOR-SALDO
              MOVE "Valor Informado Diferente do Valor do Saldo do Titul
      -            "o Deseja Atualiza-lo ?" TO MENSAGEM
              MOVE "Q" TO TIPO-MSG
              PERFORM EXIBIR-MENSAGEM
              IF RESP-MSG = "S"
                 MOVE GS-VALOR-TOTAL TO VALOR-SALDO-CR20
       ...
       FINALIZAR-PROGRAMA SECTION.
           ...
           CLOSE CAD018 CRD001 CRD020 CGD001 CGD010 CGD020
                 CXD020 CAD002 RCD100 CRD013 LOG001 LOG002 LOG003.
