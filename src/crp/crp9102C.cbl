      ...
      *GERA ARQUIVO REMESSA P/ BANCO DO BRASIL
      ...
      -    " VALOR".
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           MOVE "SEQBRC"  TO ARQ-REC.  MOVE EMPRESA-REF TO PATH-SEQBRA.
           ...
           move "CRP9102C"          to logacess-programa
      ...
      -                     "do" TO MENSAGEM
       ...
       CARREGAR-PORTADOR SECTION.
           MOVE "CRP9102C"              TO RETPORT-PROGRAMA
      ...
      * CALCULO PARA O NOSSO NUMERO -> BANCO DO BRASIL
           ...
           STRING "2444847" SEQUENCIA-W INTO NOSSO-NUMERO-T1
      ...
      *               MENSAGEM-T1
           ...
           END-IF
           MOVE 002444847                TO CONVENIO7-POS-T1
