      ...
      *GERA ARQUIVO REMESSA P/ BANCO DO BRASIL
      ...
      -    " VALOR".
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           MOVE "SEQBRA2" TO ARQ-REC.  MOVE EMPRESA-REF TO PATH-SEQBRA.
           ...
           move "CRP9103"           to logacess-programa
      ...
      -                     "do" TO MENSAGEM
       ...
       CARREGAR-PORTADOR SECTION.
           MOVE "CRP9103"              TO RETPORT-PROGRAMA
      ...
      -    "X P/ 99-XXXXXXXXXXXXXXXX" TO ANOTACAO-CR201.
       ...
       MOVER-DADOS-TIPO0 SECTION.
           ...
           MOVE 04291641000101           TO INSC-T0
           MOVE "RDA EMPRESA FOTOGRAFICA LTDA" TO NOME-EMP-T0
