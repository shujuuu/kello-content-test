      ...
      *GERA ARQUIVO REMESSA P/ BANCO DO BRASIL
      ...
      -    " VALOR".
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           MOVE "SEQBRA5" TO ARQ-REC.  MOVE EMPRESA-REF TO PATH-SEQBRA.
           ...
           move "CRP9105"           to logacess-programa
      ...
      -                     "do" TO MENSAGEM
       ...
       CARREGAR-PORTADOR SECTION.
           MOVE "CRP9105"              TO RETPORT-PROGRAMA
      ...
      -    "X P/ 99-XXXXXXXXXXXXXXXX" TO ANOTACAO-CR201.
       ...
       MOVER-DADOS-TIPO0 SECTION.
           ...
           MOVE 09628316000105           TO INSC-T0
           MOVE "MP EMPRESA FOTOGRAFICA LTDA" TO NOME-EMP-T0
      ...
      * CALCULO PARA O NOSSO NUMERO -> BANCO DO BRASIL
           ...
           STRING "1924202" SEQUENCIA-W INTO NOSSO-NUMERO-T1
      ...
      *               MENSAGEM-T1
           ...
           END-IF
           MOVE 001924202                TO CONVENIO7-POS-T1
