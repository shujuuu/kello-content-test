      ...
      *GERA ARQUIVO REMESSA P/ BANCO DO BRASIL (PRIMUS)
      ...
      -    " VALOR".
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           MOVE "SEQBRA8" TO ARQ-REC.  MOVE EMPRESA-REF TO PATH-SEQBRA.
           ...
           move "CRP9109A"          to logacess-programa
      ...
      -    "X P/ 99-XXXXXXXXXXXXXXXX" TO ANOTACAO-CR201.
       ...
       MOVER-DADOS-TIPO0 SECTION.
           ...
           MOVE 05748574000166           TO INSC-T0
           MOVE "PRIMUS RECEBIMENTOS LTDA" TO NOME-EMP-T0
      ...
      * CALCULO PARA O NOSSO NUMERO -> BANCO DO BRASIL
           ...
           STRING "2561686" SEQUENCIA-W INTO NOSSO-NUMERO-T1
      ...
      *               MENSAGEM-T1
           ...
           END-IF
           MOVE GS-MENSAGEM              TO MENSAGEM-T1
           MOVE 002561686                TO CONVENIO7-POS-T1

      *    MOVE ZEROS                    TO CODIGO-MULTA-T1
           MOVE GS-TIPO-JUROS(1:1)       TO CODIGO-MULTA-T1
           MOVE ZEROS                    TO DATA-MULTA-T1
           IF GS-TIPO-JUROS(1:1) = 1
              MOVE GS-VLR-JUROS          TO VALOR-MULTA-T1
           ELSE
              MOVE GS-TAXA-MULTA         TO VALOR-MULTA-T1
           END-IF
