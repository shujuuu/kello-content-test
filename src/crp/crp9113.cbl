      ...
      *LISTAR OS PROBLEMAS P/ QUE O USUÁRIO POSSA ACERTÁ-LO MANUALMENTE.
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           MOVE "CRP9113" TO PROGRAMA-PAR002
           ...
           move "CRP9113"           to logacess-programa
            ...
            NOT AT END
                 ...
                 EVALUATE VALIDA-RET
                     WHEN "T" MOVE REG-RETORNO TO RET-SEGMENTO-T
                              ...
                              MOVE VALOR-E       TO GS-LINDET(46: 15)
      ...
      *    procura o título através da chave vencto, docto e valor
           ...
           MOVE DATA-VENCTO-TIT-T(1:2)   TO AUX-DIA
           MOVE DATA-VENCTO-TIT-T(3:2)   TO AUX-MES
           MOVE DATA-VENCTO-TIT-T(5:4)   TO AUX-ANO
