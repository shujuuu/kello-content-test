      ...
      *PROGRAMA: ALTERA A SEQUENCIA DO BANCO DO BRASIL (PRIMUS)
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           IF ST-SEQ <> "00"
              MOVE "ERRO ABERTURA SEQBRA8 "  TO CAP002-MENSAGEM-ERRO
