      ...
      *PROCEDURE DIVISION USING POP-UP.
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           move "CADMOD"            to logacess-programa
       ...
       CARREGAR-DADOS SECTION.
           ...
           MOVE CAP012-CODIGO       TO CADMOD-CODIGO
           READ CADMOD INVALID KEY
                INITIALIZE REG-CADMOD
                MOVE 1              TO GRAVA-W.

           MOVE CADMOD-NOME         TO CAP012-NOME.
       ...
       SALVAR-DADOS SECTION.
           ...
           open i-o cadmod
           MOVE CAP012-CODIGO       TO CADMOD-CODIGO
           MOVE CAP012-NOME         TO CADMOD-NOME
           IF GRAVA-W = 1
              WRITE REG-CADMOD INVALID KEY
                   PERFORM ERRO-GRAVACAO
              END-WRITE
           ELSE
              REWRITE REG-CADMOD INVALID KEY
                   PERFORM ERRO-GRAVACAO
              NOT INVALID KEY
       ...
       ERRO-GRAVACAO SECTION.
           ...
           MOVE ST-CADMOD       TO CAP012-MENSAGEM-ERRO(23: 2)
           PERFORM LOAD-SCREENSET
           PERFORM CARREGA-MENSAGEM-ERRO
           PERFORM ACHAR-CODIGO
           SUBTRACT 1 FROM ULT-CODIGO.
       CARREGA-ULTIMOS SECTION.
           ...
           ELSE
             MOVE ZEROS TO CADMOD-CODIGO
               START CADMOD KEY IS NOT < CADMOD-CODIGO
                 INVALID KEY MOVE "10" TO ST-CADMOD.
      ...
      *         MOVE SPACES TO CAP012-LINDET
                MOVE CADMOD-CODIGO     TO CAP012-LINDET(01: 06)
                MOVE CADMOD-NOME       TO CAP012-LINDET(08: 40)
       ...
       IMPRIME-RELATORIO SECTION.
           ...
           IF CAP012-ORDER = 1
              MOVE ZEROS TO CADMOD-CODIGO
              START CADMOD KEY IS NOT < CADMOD-CODIGO INVALID KEY
                           MOVE "10" TO ST-CADMOD
           ELSE MOVE SPACES TO CADMOD-NOME
                START CADMOD KEY IS NOT < CADMOD-NOME INVALID KEY
                           MOVE "10" TO ST-CADMOD.
           MOVE ZEROS TO LIN
           PERFORM CABECALHO
           PERFORM UNTIL ST-CADMOD = "10"
             ...
             NOT AT END
                  ...
                  MOVE CADMOD-CODIGO TO LINDET-REL(01: 06)
                  MOVE CADMOD-NOME   TO LINDET-REL(08: 40)
       ...
       ACHAR-CODIGO SECTION.
           MOVE ZEROS TO CADMOD-CODIGO ULT-CODIGO
           START CADMOD KEY IS NOT < CADMOD-CODIGO INVALID KEY
                 MOVE "10" TO ST-CADMOD
           END-START
           PERFORM UNTIL ST-CADMOD = "10"
                 READ CADMOD NEXT RECORD WITH IGNORE LOCK AT END
                      MOVE "10" TO ST-CADMOD
                 NOT AT END
                      MOVE CADMOD-CODIGO TO ULT-CODIGO
                 END-READ
           END-PERFORM.
           PERFORM INCREMENTA-CODIGO.
