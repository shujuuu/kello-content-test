      ...
      *    DATA-RCTO-CR20 = AAAA/MM/DD
       ...
       01 REG-SACADOS.
          ...
          05 SAC-COD-GRUPO      PIC X(15).
          05 SAC-TIPO           PIC X(01).
          05 SAC-CPFCGC         PIC X(15).
      *   05 SAC-CPFCGC         PIC 9(11).
      *   05 FILLER             PIC X(04).
          ...
          05 SAC-EMAIL          PIC X(45).
          05 SAC-SERIE          PIC 9(05).
          05 SAC-DIA            PIC 9(02).
          05 SAC-VALOR          PIC 9(10).
      ...
      *   05 D-CPF-CNPJ            PIC X(20).
      ...
      -    "     VALOR".
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           MOVE "BOLCAI2"  TO ARQ-REC.  MOVE EMPRESA-REF
                                                      TO ARQUIVO-BOLCAIX
           ...
           move "CAIXA2"            to logacess-programa
       ...
       MOVER-DADOS SECTION.
           IF BOLCAIX-NUM-BANCO = 0
              MOVE 104                  TO BOLCAIX-NUM-BANCO
              MOVE "CAIXA ECONOMICA FEDERAL" TO BOLCAIX-NOME-BANCO
           END-IF
           ...
           EVALUATE BOLCAIX-CARTEIRA
               WHEN "1" MOVE "1 - Sem Registro"  TO GS-ACP-I-CARTEIRA
               WHEN "2" MOVE "2 - Registrada"    TO GS-ACP-I-CARTEIRA
           END-EVALUATE
       ...
       GRAVAR SECTION.
           ...
           MOVE GS-ACP-I-CARTEIRA(1:1)  TO BOLCAIX-CARTEIRA
      ...
      *D-SEU-NUMERO(13:3) => PARCELA
                     ...
                     MOVE FUNCTION NUMVAL(D-SEU-NUMERO(10:2))
                                                  TO SEQ-CR20
      ...
      *>SEQUENCIA NOSSO NUMERO (BANCO)
      ...
      -                             "válido" " | "
           ...
           IF OK = "S"
              ...
              MOVE FUNCTION NUMVAL(GS-ACP-I-CARTEIRA(1:1))
                                                     TO D-CARTEIRA
              MOVE "N"                               TO D-ACEITE
      ...
      *       STRING WS-ANO-CPU(3:2) WS-MES-CPU WS-DIA-CPU
      *                                            INTO D-PROCESSAMENTO
              ...
              MOVE D-EMISSAO                         TO D-PROCESSAMENTO
              ...
              MOVE D-DATA-DESCONTO               TO D-DATA-DESCONTO2
              MOVE D-DATA-DESCONTO               TO D-DATA-DESCONTO3
              MOVE D-VALOR-DESCONTO              TO D-VALOR-DESCONTO2
              MOVE D-VALOR-DESCONTO              TO D-VALOR-DESCONTO3
              MOVE ZEROS                             TO D-VALOR-ABATIMEN
              STRING DATA-VENCTO-CR20(7:2)
                     DATA-VENCTO-CR20(5:2)
                     DATA-VENCTO-CR20(1:4)         INTO D-DATA-MULTA
              MOVE ZEROS                             TO D-VALOR-MULTA
              MOVE "C"                               TO D-TIPO-BLOQUETO
              MOVE "S"                               TO D-COMPENSACAO
              MOVE "N"                               TO D-IMPRESSO
              MOVE SPACES                            TO D-FILLER
              MOVE SPACES                            TO D-AVALISTA
              MOVE SPACES                            TO D-TIPO-PES
              MOVE ZEROS                             TO D-CPF-CNPJ
              ...
              MOVE QTDE-PARCELAS                     TO D-QTDE-PARCE
      ...
      *D-SEU-NUMERO(13:3) => PARCELA
           ...
           STRING COD-COMPL-CR20 SEQ-CR20(4:2) PARCELA
             INTO D-SEU-NUMERO.
