      ...
      *FUNÇÃO: Listar todos os nomes (que estiverem na categoria de
      *        representante) buscando do cadastro geral, para que seja
      *        lançado o salário referênte ao mês.
      *        Após ler os lançamentos no CCD115.
      ...
      *    SELECIONADA
       ...
       01  CAB02.
           ...
           "RELACAO DE LANCAMENTOS DE SALARIOS DE REPRESETANTE".
           05  FILLER              PIC X(8)    VALUE SPACES.
           05  FILLER              PIC X(9)    VALUE 'MES/ANO: '.
           05  MESANO-REL          PIC 99/99/9999.
           05  FILLER              PIC X(8)    VALUE SPACES.
      ...
      -    "      SALARIO-1    SALARIO-2        SALDO  MES/ANO".
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           OPEN OUTPUT WORK.
           IF ST-CCD115 = "35"
              CLOSE CCD115    OPEN OUTPUT CCD115  CLOSE CCD115
              OPEN I-O CCD115.
           IF ST-CGD001 <> "00"
      ...
      *                                  MOVE 1 TO IMPRIME-W
      *    END-EVALUATE.
           IF T-REPRES-CG01 = 1 MOVE 1 TO IMPRIME-W.
       ...
       CARREGA-LISTA SECTION.
           ...
           PERFORM UNTIL ST-WORK = "10"
              ...
              NOT AT END
               ...
               MOVE CODIGO-WK         TO CODIGO-CC115 GS-LINDET(115: 6)
               MOVE MESANO-I          TO MESANO-BASE-CC115
               READ CCD115 INVALID KEY CONTINUE
                  NOT INVALID KEY
                     MOVE SALARIO1-CC115    TO VALOR-E TOTAL-W
                     MOVE VALOR-E           TO GS-LINDET(33: 13)
                     MOVE SALARIO2-CC115    TO VALOR-E
                     MOVE VALOR-E           TO GS-LINDET(46: 13)
                     ADD SALARIO2-CC115     TO TOTAL-W
                     MOVE TOTAL-W           TO VALOR-E
                     MOVE VALOR-E           TO GS-LINDET(59: 13)
                     ADD SALARIO1-CC115     TO TOTAL-SALARIO1
                     ADD SALARIO2-CC115     TO TOTAL-SALARIO2
                END-READ
       ...
       DUPLICA-LANCAMENTOS SECTION.
           ...
           PERFORM UNTIL ST-WORK = "10"
              ...
              NOT AT END
               ...
               READ CCD115 INVALID KEY CONTINUE
                  NOT INVALID KEY
                     MOVE MESANO-DUP        TO MESANO-BASE-CC115
                     MOVE ZEROS             TO VALOR-LIBERADO-CC115
                                               ATUALIZADO-CC-CC115
                     MOVE USUARIO-W         TO DIGITADOR-CC115
                     MOVE DATA-DIA-I        TO DATA-MOVTO-CC115
                     WRITE REG-CCD115
                     END-WRITE
                END-READ
              END-READ
       ...
       ENTRA-DADOS SECTION.
           ...
           MOVE GS-LINDET(115: 6)  TO CODIGO-CC115.
           MOVE MESANO-I           TO MESANO-BASE-CC115
           READ CCD115 INVALID KEY
                       MOVE 1 TO GRAVA1-REGRAVA2
                       MOVE ZEROS TO GS-SALARIO1 GS-SALARIO2
             NOT INVALID KEY
                 MOVE SALARIO1-CC115   TO GS-SALARIO1
                 MOVE SALARIO2-CC115   TO GS-SALARIO2
                 MOVE 2                TO GRAVA1-REGRAVA2
           END-READ
           MOVE "REFRESH-DATA" TO DS-PROCEDURE.
           PERFORM CALL-DIALOG-SYSTEM.
       GRAVA-DADOS SECTION.
           MOVE GS-SALARIO1       TO SALARIO1-CC115 VALOR-E TOTAL-W
           MOVE VALOR-E           TO GS-LINDET(33: 13)
           MOVE GS-SALARIO2       TO SALARIO2-CC115 VALOR-E
           MOVE VALOR-E           TO GS-LINDET(46: 13)
           ADD GS-SALARIO2        TO TOTAL-W
           MOVE TOTAL-W           TO VALOR-E
           MOVE VALOR-E           TO GS-LINDET(59: 13)
           MOVE MESANO-I          TO MESANO-BASE-CC115
           MOVE ZEROS             TO ATUALIZADO-CC-CC115
           MOVE USUARIO-W         TO DIGITADOR-CC115
           MOVE DATA-DIA-I        TO DATA-MOVTO-CC115
           MOVE ZEROS             TO VALOR-LIBERADO-CC115
           WRITE REG-CCD115 INVALID KEY
                 MOVE "CCD115"    TO GS-MENSAGEM-ERRO(15: 7)
                 MOVE "ST-CCD115" TO GS-MENSAGEM-ERRO(23: 2)
           ...
           PERFORM UNTIL ST-CCD115 = "10"
             READ CCD115 NEXT RECORD AT END MOVE "10" TO ST-CCD115
               NOT AT END
                 ...
                 COMPUTE VALOR-CC100 = SALARIO1-CC115 + SALARIO2-CC115
                 MOVE 0                  TO CRED-DEB-CC100
                 MOVE DATA-DIA-I         TO DATA-MOVTO-CC100
                                            DATA-EMISSAO-CC100
                 MOVE 3                  TO TIPO-LCTO-CC100
                 ...
                 MOVE USUARIO-W          TO RESPONSAVEL-CC100
                                            DIGITADOR-CC100
                 MOVE CODIGO-CC115 TO FORNEC-CC100 FORNEC-CC101
       ...
       REGRAVA-DADOS SECTION.
           ...
           MOVE GS-SALARIO2       TO SALARIO2-CC115 VALOR-E
           MOVE VALOR-E           TO GS-LINDET(46: 14)
           ADD GS-SALARIO2        TO TOTAL-W
           MOVE TOTAL-W           TO VALOR-E
           ...
           MOVE MESANO-I          TO MESANO-BASE-CC115
           MOVE USUARIO-W         TO DIGITADOR-CC115
           REWRITE REG-CCD115 INVALID KEY
                        MOVE "CCD115"    TO GS-MENSAGEM-ERRO(15: 7)
                        MOVE "ST-CCD115" TO GS-MENSAGEM-ERRO(23: 2)
                        PERFORM ERRO-GRAVACAO.
           PERFORM LIMPAR-ENTRADA.
