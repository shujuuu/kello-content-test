       ...
       PROGRAM-ID. COP007.
      *--------------------------------------------------------------*
      *    DATA  : 16 DEZEMBRO 1999
      *    AUTORA: MARELI AMANCIO VOLPATO
      *    FUNCAO: GERA ARQUIVO 05 - PRE-GRAVADO
      *--------------------------------------------------------------*
      ...
      *    05  FILLER          PIC XX       VALUE "II".
          03  LINDETP2.
           ...
           05  FILLER          PIC X        VALUE SPACES.
           05  FOTPROD-REL     PIC ZZZ999   BLANK WHEN ZEROS.
           05  FILLER          PIC X        VALUE SPACES.
      ...
      *    05  FILLER          PIC X        VALUE SPACES.
       ...
       ERRO-GRAVACAO SECTION.
           ...
           MOVE ST-COD007       TO GS-MENSAGEM-ERRO(23: 2)
           PERFORM LOAD-SCREENSET
           PERFORM CARREGA-MENSAGEM-ERRO.
       CLEAR-FLAGS SECTION.
           ...
           PERFORM UNTIL ST-MTD001 = "10"
            ...
            NOT AT END
                 MOVE CONTRATO-MT01 TO CONTRATO-WK CONTRATO-WS CONTR-W
                                       NR-CONTRATO-CO40
                 MOVE "CONTRATO: " TO GS-MENSAGEM
                 MOVE CONTRATO-MT01  TO GS-MENSAGEM(11: 4)
                 MOVE "EXIBE-MENSAGEM" TO DS-PROCEDURE
                 PERFORM CALL-DIALOG-SYSTEM
       ...
       NAOREALIZADO SECTION.
           ...
           PERFORM UNTIL ST-COD040 = "10"
             READ COD040 NEXT RECORD AT END MOVE "10" TO ST-COD040
               NOT AT END
                IF MESANO-PREV-CO40 > CAMPANHA-2 MOVE "10" TO ST-COD040
                ELSE
                 MOVE "CONTRATO: "      TO GS-MENSAGEM
                 MOVE NR-CONTRATO-CO40  TO GS-MENSAGEM(11: 4)
                 MOVE "EXIBE-MENSAGEM"  TO DS-PROCEDURE
                 PERFORM CALL-DIALOG-SYSTEM
