      ...
      *FUNÇÃO: Movimento de BRINDES - SUBPROGRAMA
      ...
      *    ACCEPT PARAMETROS-W FROM COMMAND-LINE.
           ...
           OPEN INPUT COD050 COD051 COD049

           OPEN INPUT CAD004 IED011 COD002 CGD001 COD040 PAR001.
           IF ST-COD050 = "35"
      ...
      -               "ormado" TO MENSAGEM
       ...
       CHAMADA-SUBPROGRAMA SECTION.
           ...
           MOVE STRING-1(1: 4)      TO NR-CONTRATO-CO50
           MOVE STRING-1(5: 4)      TO ITEM-CO50
           IF ITEM-CO50 <> ZEROS    PERFORM CARREGAR-DADOS
      ...
      *----------------------------------------------------------------
       ...
       CARREGAR-DADOS SECTION.
           START COD050 KEY IS = CHAVE-CO50 INVALID KEY CONTINUE.
           READ COD050 INVALID KEY INITIALIZE REG-COD050.
           MOVE NR-CONTRATO-CO50     TO  GS-CONTRATO
           MOVE ITEM-CO50            TO  GS-NR-ITEM
           MOVE CODBRINDE-CO50       TO  GS-COD-BRINDE CODIGO-CO02
           READ COD002 INVALID KEY MOVE "*******" TO NOME-CO02.
           MOVE NOME-CO02            TO  GS-NOME-BRINDE
           MOVE CURSO-CO50           TO  GS-CURSO CODIGO-IE11
           READ IED011 INVALID KEY MOVE "*****" TO NOME-IE11.
           MOVE NOME-IE11            TO  GS-NOME-CURSO.
           ...
           MOVE COD-FORNEC-CO50      TO  GS-FORNEC CODIGO-CG01.
           READ CGD001 INVALID KEY MOVE "********" TO NOME-CG01.
           MOVE NOME-CG01            TO  GS-NOME-FORN
       ...
       FINALIZAR-PROGRAMA SECTION.
           CLOSE CAD004 COD002 COD040 COD050 IED011 CGD001 COD051
                 COD049.
