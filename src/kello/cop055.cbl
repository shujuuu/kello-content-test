      ...
      *    variáveis p/ listar os nomes com iniciais solicitadas
      ...
      -    "IAS FORNEC".
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           OPEN INPUT COD055 COD055i PAR001 COD049


           OPEN INPUT IED011 COD009 CGD001 COD040 CAD004.
           IF ST-COD055 = "35"
                ...
                EVALUATE STATUS-CO40
                    ...
                    WHEN OTHER
                         ...
                         NOT INVALID KEY
                              ...
                              ELSE
                                 MOVE 0 TO GS-FLAG-CRITICA
                                 MOVE QTDE-FORM-CO40 TO GS-QTDE-FORM
                              END-IF
                         END-READ
                END-EVALUATE.
      ...
      *----------------------------------------------------------------
       ...
       CARREGAR-DADOS SECTION.
           ...
           MOVE CODBRINDE-CO55          TO GS-COD-BRINDE
                                           CODIGO-CO09
           READ COD009 INVALID KEY
                MOVE "*******"          TO NOME-CO09.
           MOVE NOME-CO09               TO GS-NOME-BRINDE
           MOVE CURSO-CO55              TO GS-CURSO
                                           CODIGO-IE11
           ...
           MOVE COD-FORNEC-CO55         TO GS-FORNEC
                                           CODIGO-CG01.
       ...
       FINALIZAR-PROGRAMA SECTION.
           CLOSE COD009 COD040 COD055 COD055i IED011 CGD001 COD049.
           CLOSE CAD004.
