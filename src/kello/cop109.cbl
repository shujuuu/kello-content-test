      ...
      *    VARIAVEIS P/ CALCULO DE PATROCINIO PAGOS E A PAGAR
      ...
      -    "FOTOS FITA    PREV.VENDA    PATROCINIO   PAT.FORM".
       01  CAB05.
           05  FILLER              PIC X(2)    VALUE SPACES.
           05  FILLER              PIC X(126)   VALUE
                "DATA ---FORMANDO---- -----------FOTOGRAFIAS-----------
      -    "VEND -RESULT.FOTOS %--                                     -
      -    "-OUTROS--".
       01  CAB06.
           05  FILLER              PIC X(2)    VALUE SPACES.
           05  FILLER              PIC X(126)   VALUE
                "REAL. PROD VEND SALD DISP.COMIS FOGO VENDA DEVOL SALDO
      -    "FITA VENDA DEVOL SALDO   P.M. VDA.LIQ.IN P/FOTO   V.MED.   D
      -    "VD POSTER".
       01  LINDET.
           05  FILLER              PIC X(2)    VALUE SPACES.
      ...
      -    "------------------------------------- ".
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           OPEN INPUT CAD010 CGD001 COD040 COD005 COD050 COD051
       ...
       MOVER-DADOS-WORK SECTION.
           ...
           IF STATUS-CO40 < 50 OR STATUS-CO40 = 56
              CONTINUE
           ELSE
              IF GS-REGIAO = REGIAO-CID OR GS-REGIAO = 0
       ...
       INICIO-MONTAGEM SECTION.
           ...
           READ MTD001 INVALID KEY MOVE ZEROS TO FOTPROD-WK
                          FOTPERD-WK FOTMONT-WK ALBPROD-WK
            NOT INVALID KEY
      ...
      *--------------------------------------------------------------
      ...
      -    "RM P FOTOS FITA    PREV.VENDA    PATROCINIO   PAT/FORM" TO
           GS-LINDET
           MOVE "INSERE-LIST" TO DS-PROCEDURE
           PERFORM CALL-DIALOG-SYSTEM.

           MOVE "DATA ---FORMANDO---- -----------FOTOGRAFIAS-----------
      -    "VEND -RESULT.FOTOS %--                                     -
      -    "-OUTROS--" TO GS-LINDET
           MOVE "INSERE-LIST" TO DS-PROCEDURE
           PERFORM CALL-DIALOG-SYSTEM.

           MOVE "REAL. PROD VEND SALD DISP.COMIS FOGO VENDA DEVOL SALDO
      -    "FITA VENDA DEVOL SALDO   P.M. VDA.LIQ.IN P/FOTO   V.MED.   D
      -    "VD POSTER" TO GS-LINDET
           MOVE "INSERE-LIST" TO DS-PROCEDURE
           PERFORM CALL-DIALOG-SYSTEM.
      ...
      *                           + FOTFOGO-WK).
           ...
           MOVE FOTCOMIS-WK         TO GS-LINDET(28: 5)
           MOVE FOTFOGO-WK          TO GS-LINDET(33: 5)
           MOVE FOTVEND-WK          TO GS-LINDET(38: 6)
           MOVE FOTDEVO-WK          TO GS-LINDET(44: 6)
      ...
      *    2o. LINHA DA LINDET
           ...
           MOVE FOTCOMIS-WK         TO LINDET-REL(28: 5)
           MOVE FOTFOGO-WK          TO LINDET-REL(33: 5)
           MOVE FOTVEND-WK          TO LINDET-REL(38: 6)
           MOVE FOTDEVO-WK          TO LINDET-REL(44: 6)
           ...
           MOVE SALFOT-W            TO LINDET-REL(50: 6)
           MOVE FITA-WK             TO LINDET-REL(56: 5)
           ...
           COMPUTE PERC-W = (SALFOT-W / DISPONIVEL-W) * 100.
           MOVE PERC-W              TO PERC-E
           MOVE PERC-E              TO LINDET-REL(73: 6)

           COMPUTE PRAZO-W = PRAZO-WK / FATVENBRU-WK.
           MOVE PRAZO-W             TO PRAZO-E
           MOVE PRAZO-E             TO LINDET-REL(79: 7)

           MOVE VENLIQIND-WK        TO VALOR-E
           MOVE VALOR-E             TO LINDET-REL(86: 11)
           COMPUTE PRECOMED-W = VENLIQIND-WK / FOTVEND-WK.
           MOVE PRECOMED-W          TO VALOR-E3
           MOVE VALOR-E3            TO LINDET-REL(97: 5)
           COMPUTE VENMEDCLI-W = VENLIQIND-WK / FORMANDOS-WK.
           MOVE VENMEDCLI-W         TO VALOR-E4
           MOVE VALOR-E4            TO LINDET-REL(104: 09)

           MOVE DVD-WK              TO LINDET-REL(114: 5)
           MOVE POSTER-WK           TO LINDET-REL(121: 5)
       ...
       FINALIZAR-PROGRAMA SECTION.
           CLOSE COD040 COD050 CAD010 CAD012 CGD001 COD051
