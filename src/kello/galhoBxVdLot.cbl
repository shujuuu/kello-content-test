      ...
      *    ou alfabético
       ...
       01 POSSE-W                      pic 9(01) value zeros.
      ...
      *    accept parametros-w from command-line.
       ...
       LER-POSSE SECTION.
           MOVE GS-POSSE-ATUAL TO CODIGO-CG01
       ...
       SUGESTAO-POSSE SECTION.
           ...
           IF POSSE-W = 1
              CALL   "MTP002T" USING PARAMETROS-W
                                     PASSAR-STRING-1
              CANCEL "MTP002T"
              MOVE PASSAR-STRING-1(16: 2) TO GS-POSSE-ATUAL
              MOVE PASSAR-STRING-1(1: 20) TO GS-DESC-POSSE
           ELSE
              CALL   "CGP001T" USING PARAMETROS-W
                                     PASSAR-STRING-1
              CANCEL "CGP001T"
              MOVE PASSAR-STRING-1(33: 6) TO GS-POSSE-ATUAL
              MOVE PASSAR-STRING-1(1: 20) TO GS-DESC-POSSE
           END-IF.
      ...
      *    stop run.
       ...
       POR-ROMANEIO SECTION.
           MOVE FUNCTION NUMVAL(GS-POSSE(1: 1))  TO POSSE-W
           ...
           MOVE GS-DATA-ROMANEIOF      TO DATA-INV
           CALL "GRIDAT2" USING DATA-INV
           ...
           PERFORM UNTIL ST-MTD020 = "10"
                 READ MTD020 NEXT AT END
                      MOVE "10" TO ST-MTD020
                 NOT AT END
                      IF DATAROMANEIO-MTG > DATA-INV
                         MOVE "10" TO ST-MTD020
                      ELSE
                         IF GS-NR-CONTRATO = 0 OR CONTRATO-MTG
                            IF GS-ALBUM-INI = 0 OR NRALBUM-MTG NOT <
                                                   GS-ALBUM-INI
                               IF GS-ALBUM-FIM = 0 OR NRALBUM-MTG NOT >
                                                      GS-ALBUM-FIM
                                 IF POSSE-W = 0 OR POSSE-MTG
                                    IF GS-POSSE-ATUAL = 0 OR
                                       CODIGO-POSSE-MTG
                                       MOVE CONTRATO-MTG TO
                                            NR-CONTRATO-CO40
      ...
      *    MOVE  7                 TO LOG-TEXTO5
       ...
       FINALIZAR-PROGRAMA SECTION.
           ...
           CLOSE MTD020 COD040 CAD010 CGD001
