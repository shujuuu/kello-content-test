      ...
      *    ou alfabético
       ...
       01  CAB02.
           ...
           "RELACAO DE IMPRESSORA - LABORATORIO ".
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           MOVE 1 TO GRAVA-W.
           IF ST-LBD026 = "35"
              CLOSE LBD026      OPEN OUTPUT LBD026
              CLOSE LBD026      OPEN I-O LBD026
           END-IF.
           IF ST-LBD026 <> "00"
       ...
       CARREGAR-DADOS SECTION.
           ...
           MOVE GS-CODIGO       TO CODIGO-LB26.
           READ LBD026 INVALID KEY INITIALIZE REG-LBD026
                                   MOVE 1 TO GRAVA-W.
       ...
       SALVAR-DADOS SECTION.
           MOVE GS-CODIGO       TO CODIGO-LB26.
           MOVE GS-DESCRICAO    TO DESCRICAO-LB26.
           IF GRAVA-W = 1
              WRITE REG-LBD026 INVALID KEY
                   PERFORM ERRO-GRAVACAO
           ELSE REWRITE REG-LBD026 INVALID KEY
                PERFORM ERRO-GRAVACAO
               NOT INVALID KEY
       ...
       ERRO-GRAVACAO SECTION.
           ...
           MOVE ST-LBD026       TO GS-MENSAGEM-ERRO(23: 2)
           PERFORM LOAD-SCREENSET
           PERFORM CARREGA-MENSAGEM-ERRO
           PERFORM ACHAR-CODIGO
           SUBTRACT 1 FROM ULT-CODIGO.
       CARREGA-ULTIMOS SECTION.
           ...
           ELSE
             MOVE ZEROS TO CODIGO-LB26
               START LBD026 KEY IS NOT < CODIGO-LB26
                 INVALID KEY MOVE "10" TO ST-LBD026.
           ...
           PERFORM UNTIL ST-LBD026 = "10"
              ...
              NOT AT END
                ADD 1 TO GS-CONT
                MOVE SPACES TO GS-LINDET
                MOVE CODIGO-LB26          TO GS-LINDET(01: 06)
                MOVE DESCRICAO-LB26       TO GS-LINDET(07: 31)
       ...
       IMPRIME-RELATORIO SECTION.
           ...
           IF GS-ORDER = 1
              MOVE ZEROS TO CODIGO-LB26
              START LBD026 KEY IS NOT < CODIGO-LB26 INVALID KEY
                           MOVE "10" TO ST-LBD026
           ELSE MOVE SPACES TO DESCRICAO-LB26
                START LBD026 KEY IS NOT < DESCRICAO-LB26 INVALID KEY
                           MOVE "10" TO ST-LBD026.
             ...
             READ LBD026 NEXT RECORD AT END MOVE "10" TO ST-LBD026
              NOT AT END
               MOVE SPACES TO LINDET-REL
                MOVE CODIGO-LB26              TO LINDET-REL(01: 06)
                MOVE DESCRICAO-LB26           TO LINDET-REL(07: 31)
       ...
       ACHAR-CODIGO SECTION.
           MOVE ZEROS TO ULT-CODIGO ST-LBD026.
           PERFORM UNTIL ST-LBD026 = "10"
             ADD 1 TO ULT-CODIGO
             MOVE ULT-CODIGO TO CODIGO-LB26
             READ LBD026 INVALID KEY MOVE "10" TO ST-LBD026
