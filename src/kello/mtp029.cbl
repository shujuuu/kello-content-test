      ...
      *    ERRO-W - flag que controla se houve erro de abertura arquivo
      ...
      -    "       FONE IDENT TUR TURNO".
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           CLOSE      MTD025 CGD010 CGD011  MTD019F
           OPEN I-O   MTD025 MTD019F
      ...
      *       PERFORM CARREGA-MENSAGEM-ERRO.
           ...
           close      mtd019 mtd019f mtd025 log001 log002
           open input mtd019 mtd019f mtd025
      ...
      *            PERFORM CARREGA-ULTIMOS
               ...
               WHEN GS-VERIFICAR-IMAGEM-TRUE
                    PERFORM VERIFICAR-CONTRATO
           END-EVALUATE.
           PERFORM CLEAR-FLAGS.
           PERFORM CALL-DIALOG-SYSTEM.
       ...
       VERIFICAR-CONTRATO SECTION.
           IF GS-ACP-IMAGEM <> SPACES
              PERFORM VISUALIZAR-IMAGEM.
       VERIFICAR-CONTRATO-FIM.
           EXIT.
       ...
       CENTRALIZAR SECTION.
          ...
          move-object-handle win-foto handle8
          move handle8 to wHandle
          invoke Window "fromHandleWithClass" using wHandle Window
                 returning janelaPrincipal
      ...
      *            PERFORM EXIBIR-MENSAGEM.
       ...
       CRITICAR-IMAGEM SECTION.
              IF GS-ACP-IMAGEM EQUAL SPACES or "*.*"
      ...
      *    display "Cidade-mt19 = " cidade-mt19 stop " "
           ...
           NOT INVALID KEY
               MOVE E-MAIL2-CG11         TO  GS-EMAIL-RES
           ...
           MOVE ALBUM-MT19            TO ALBUM-MT19F
           READ MTD019F INVALID KEY
                INITIALIZE REG-MTD019F.

           MOVE IMAGEM-MT19F          TO GS-ACP-IMAGEM
      ...
      *    PERFORM CALL-DIALOG-SYSTEM
       ...
       SALVAR-DADOS SECTION.
           MOVE GS-NR-CONTRATO        TO CONTRATO-MT19    CONTRATO-MT19F
           MOVE GS-NR-ALBUM           TO SEQ-MT19         SEQ-MT19F
           ...
           MOVE GS-COMP-TEL-RES       TO COMP-TEL-MT19
      ...
      *         MOVE GS-TELEFONE-RES      TO FONE1-CG11
                ...
                MOVE GS-EMAIL-RES         TO E-MAIL2-CG11
                ...
                MOVE GS-COMP-CEL-RES      TO COMP-CEL2-CG11

                MOVE GS-COMP-TEL-RES      TO COMP-TEL2-CG11
      ...
      *         MOVE GS-RAMAL-COM         TO RAMAL2-CG11
                ...
                MOVE GS-COMP-TEL-COM      TO COMP-TEL3-CG11
                ...
                MOVE GS-COMP-TEL-PAI            TO COMP-TEL-PAIS-CG11
                MOVE GS-CELULAR-PAI             TO CELULAR-PAIS-CG11
                MOVE GS-COMP-CEL-PAI            TO COMP-CEL-PAIS-CG11
      ...
      *         MOVE GS-RAMAL-COM         TO RAMAL2-CG11
       ...
       MOVER-DADOS-LISTA SECTION.
           ...
           IF COMP-TEL-MT19 IS NOT NUMERIC
              MOVE 0 TO COMP-TEL-MT19
           END-IF
           IF COMP-TEL-MT19 > 0
              MOVE COMP-TEL-MT19   TO GS-LINDET(64: 1)
           END-IF
           MOVE FONE-MT19          TO GS-LINDET(65: 9)
           MOVE IDENTIFICADO-MT19  TO GS-LINDET(74: 1)
           MOVE TURMA-MT19         TO GS-LINDET(79: 4)
           MOVE TURNO-MT19         TO GS-LINDET(83:10).
      ...
      *-------------------------------------------------------
           ...
           PERFORM UNTIL ST-MTD019 = "10"
               ...
               NOT AT END
                    ...
                    ELSE
                       ...
                       END-IF
                       IF COMP-TEL-MT19 > 0
                          MOVE COMP-TEL-MT19   TO LINDET-REL(64: 1)
                       END-IF
                       MOVE FONE-MT19          TO LINDET-REL(65: 9)
                       MOVE IDENTIFICADO-MT19  TO LINDET-REL(74: 1)
                       MOVE TURMA-MT19         TO LINDET-REL(79: 4)
                       MOVE TURNO-MT19         TO LINDET-REL(83:10)
       ...
       FINALIZAR-PROGRAMA SECTION.
           CLOSE CAD010 COD040 MTD019 IED011  CAD004 COD008  MTD025
                 CGD010 CGD011 IED010 MTD019F PAR001
