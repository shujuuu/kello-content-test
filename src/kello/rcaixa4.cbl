      ...
      *LISTAR OS PROBLEMAS P/ QUE O USUÁRIO POSSA ACERTÁ-LO MANUALMENTE.
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           MOVE "RCAIXA4"  TO PROGRAMA-PAR002
           READ PAR002 INVALID KEY
                MOVE "PARAMETRIZAR NO PAR002 O RCAIXA4" TO
                GS-MENSAGEM-ERRO
                PERFORM CARREGA-MENSAGEM-ERRO.
           ...
           move "RCAIXA4"           to logacess-programa
       ...
       CARREGAR-PORTADOR SECTION.
           MOVE "RCAIXA4"              TO RETPORT-PROGRAMA
      ...
      *    DISPLAY "VOU BAIXAR " AT 1001
           ...
           REWRITE REG-CRD020 INVALID KEY
      *         DISPLAY "NAO ENCONTREI" AT 1201
                PERFORM TITULOS-NAO-ENCONTRADO
           NOT INVALID KEY
      *         DISPLAY "BAIXEI CRD020" AT 1201
                ...
                READ CRD020B INVALID KEY
                     ...
                     WRITE REG-CRD020B INVALID KEY
                          PERFORM TITULOS-NAO-ENCONTRADO
      *              NOT INVALID KEY
      *                   DISPLAY "BAIXEI CRD020B" AT 1301
                     END-WRITE
                NOT INVALID KEY
                     MOVE VALOR-TOT-CR20     TO VALOR-TOT-CR20B
                     MOVE JURO-RCTO-CR20     TO JURO-RCTO-CR20B
      ...
      *                   DISPLAY "BAIXEI CRD020B" AT 1301
       ...
       PROCURA-TITULO SECTION.
           ...
           MOVE RT-NUMERO-DOCTO(1:1)    TO CLASS-CLIENTE-CR20
           MOVE RT-NUMERO-DOCTO(2:8)    TO CLIENTE-CR20
           MOVE FUNCTION NUMVAL(RT-NUMERO-DOCTO(10:2)) TO SEQ-CR20

           READ CRD020 INVALID KEY
                PERFORM PROCURAR-OUTRA-FORMA
           NOT INVALID KEY
      *         DISPLAY "RT-NUMERO-DOCTO = " AT 0101
      *         DISPLAY  RT-NUMERO-DOCTO     AT 0120
      *         DISPLAY "RU-COD-MOV = "      AT 0201
      *         DISPLAY  RU-COD-MOV          AT 0220
                EVALUATE RU-COD-MOV
