      ...
      *PROGRAMA: RESUMO DE PRODUÇAO POR IMPRESSORA
      *FUNÇÃO: Fazer um resumo de fotos produzidas e tempo consumido
       ...
       FILE-CONTROL.
           ...
           SELECT WORK ASSIGN TO VARIA-W
                  ...
                  STATUS IS ST-WORK
                  RECORD KEY IS COD-IMPRESSORA-WK
                  ALTERNATE RECORD KEY IS
                      IMPRESSORA-WK WITH DUPLICATES.
       ...
       FD  WORK.
       01  REG-WORK.
           05  COD-IMPRESSORA-WK   PIC 9(2).
           05  IMPRESSORA-WK       PIC X(20).
      ...
      *    VARIAVEIS P/ CALCULO DE HORAS
       ...
       01  CAB02.
           ...
           "RESUMO DE PRODUCAO POR IMPRESSORA".
       ...
       01  CAB04.
           ...
           "IMPRESSORA                      PRODUZIDO   %-PRO
      -    "TEMPO    %-TEM          INTERRUP    %-INT".
       01  LINDET.
           05  FILLER              PIC X(5)    VALUE SPACES.
             ...
             READ LBD103 NEXT RECORD AT END MOVE "10" TO ST-LBD103
              NOT AT END
               ...
               ELSE
                ...
                PERFORM CALL-DIALOG-SYSTEM
                MOVE IMPRESSORA-L103    TO COD-IMPRESSORA-WK
                PERFORM CALCULA-HORAS
                READ WORK INVALID KEY
                     INITIALIZE REG-WORK
                     MOVE IMPRESSORA-L103  TO COD-IMPRESSORA-WK
                                               CODIGO-LB26
                     PERFORM LER-IMPRESSORA
       ...
       MOVER-DADOS-LINDET SECTION.
           ...
           PERFORM CALL-DIALOG-SYSTEM.
       MOVER-DADOS SECTION.
           MOVE IMPRESSORA-WK   TO GS-LINDET(1: 31)
           MOVE PRODUZIDAS-WK    TO QTDE-E
           MOVE QTDE-E           TO GS-LINDET(32: 11)
           COMPUTE PERC-E = (PRODUZIDAS-WK / TOTAL-PRODUZIDO) * 100
           MOVE PERC-E           TO GS-LINDET(44: 7)
       ...
       IMPRIME-RELATORIO SECTION.
           ...
           MOVE TOTAL-PRODUZIDO  TO QTDE-E
           MOVE QTDE-E           TO LINDET-REL(32: 11)
           COMPUTE PERC-E = (TOTAL-PRODUZIDO / TOTAL-PRODUZIDO) * 100
           MOVE PERC-E           TO LINDET-REL(44: 7)
           COMPUTE TOT-HORA = (TOTAL-TEMPO-DECOR - TOTAL-INTERVALO)
                               / 60
           COMPUTE TOT-MIN = (TOTAL-TEMPO-DECOR - TOTAL-INTERVALO)
                             - (TOT-HORA * 60)
           MOVE TOT-HORA TO HOR-E
           MOVE TOT-MIN TO MIN-E
           MOVE TEMPO-E          TO LINDET-REL(57: 10)
           COMPUTE PERC-E = (TOTAL-TEMPO-DECOR / TOTAL-TEMPO-DECOR)
                            * 100
           MOVE PERC-E           TO LINDET-REL(69: 7)

           COMPUTE TOT-HORA = TOTAL-INTERRUPCAO / 60
           COMPUTE TOT-MIN = TOTAL-INTERRUPCAO - (TOT-HORA * 60)
           MOVE TOT-HORA         TO HOR-E
           MOVE TOT-MIN          TO MIN-E
           MOVE TEMPO-E          TO LINDET-REL(84: 10)
           COMPUTE PERC-E = (TOTAL-INTERRUPCAO / TOTAL-INTERRUPCAO)
                            * 100
           MOVE PERC-E           TO LINDET-REL(96: 7).
