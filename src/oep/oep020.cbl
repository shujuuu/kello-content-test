       ...
       DATE-WRITTEN. 13/01/2000.
      *FUNÇÃO: Movimento de BRINDES DE ORGANIZAÇÃO DE EVENTOS
      ...
      *    variáveis p/ listar os nomes com iniciais solicitadas
      ...
      -    "IAS FORNEC".
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           OPEN I-O OED020.
           OPEN INPUT IED011 COD002 CGD001 OED010.
           IF ST-OED020 = "35"
       ...
       CORPO-PROGRAMA SECTION.
           EVALUATE TRUE
               ...
               WHEN GS-VERIF-DATA-SOLIC-TRUE
                    PERFORM VERIF-DATA-SOLICITACAO
               WHEN GS-VERIF-CONTRATO-TRUE
                    PERFORM VERIF-CONTRATO-CADASTRADO
           END-EVALUATE.
           PERFORM CLEAR-FLAGS.
       ...
       VERIF-CONTRATO-CADASTRADO SECTION.
      *    verifica se o contrato está cadastrado na org.de eventos
           MOVE GS-CONTRATO     TO NR-CONTRATO-OE10.
           READ OED010 INVALID KEY MOVE 1 TO GS-ERRO-CONTRATO
                   NOT INVALID KEY MOVE 0 TO GS-ERRO-CONTRATO.
       VERIF-DATA-SOLICITACAO SECTION.
           MOVE GS-CONTRATO     TO NR-CONTRATO-OE10
           READ OED010 INVALID KEY MOVE ZEROS TO ASSINATURA-OE10
           END-READ
           MOVE GS-DATA-SOLICIT TO DATA-INV
           CALL "GRIDAT2" USING DATA-INV
           IF DATA-INV < ASSINATURA-OE10 MOVE 1 TO GS-ERRO-DATA-SOLIC
           ELSE MOVE ZEROS TO GS-ERRO-DATA-SOLIC.
      ...
      *----------------------------------------------------------------
       ...
       CARREGA-ULTIMOS SECTION.
           ...
           PERFORM UNTIL ST-OED020 = "10"
               READ OED020 NEXT RECORD AT END
                    MOVE "10" TO ST-OED020
               NOT AT END
       ...
       FINALIZAR-PROGRAMA SECTION.
           CLOSE COD002 OED010 OED020 IED011 CGD001.
