      ...
      *    M - controla o intervalo de eventoRque deverá ser impresso
           05  M                        PIC 99    VALUE ZEROS.
      *    P controla a coluna de impressão
      ...
      *       PERFORM CARREGA-MENSAGEM-ERRO.
       ...
       VALIDA SECTION.
           ...
           if aux-mes = 0 or aux-mes > 12
              move "Mês informado inválido" to mensagem
              move "C" to tipo-msg
              perform exibir-mensagem
           else
              if aux-dia = 0 or aux-dia > 31
                 move "Dia informado inválido" to mensagem
                 move "C" to tipo-msg
                 perform exibir-mensagem
              else
                 if gs-ano > 0 and gs-seq > 0
                    ...
                    start prd100 key is not less chave-pr100 invalid key
                         move "Planejamento não encontrado" to mensagem
                         move "C" to tipo-msg
                         perform exibir-mensagem
                    not invalid key
                         read prd100 next at end
                              move "Planejamento não encontrado"
                                       to mensagem
                              move "C" to tipo-msg
                              perform exibir-mensagem
                         not at end
      ...
      *    ACHA O NÍVEL QUE SE DEVE CHEGAR O CONTADOR DE EVENTO
      ...
      *    LOOP DO M = CONTROLA QUAL INTERVALO DE EVENTO DEVERÁ SER
      *    IMPRESSO. Ex. 1 à 10, 11 à 20 ou 21 à 30, 31 à 40

           MOVE ZEROS TO M
           PERFORM VARYING M FROM 1 BY 1 UNTIL M > LIMITE-EVENTO
      *      DELIMITA OS EVENTOS QUE DEVERÃO SER SELECIONADOS
             EVALUATE M
      ...
      *    imprime previsão financeira
       ...
       IMPRIME-DADOS-HOTEL SECTION.
           ...
           PERFORM CABECALHO.
      *    não há necessidade de controle de linhas nesta pagina
