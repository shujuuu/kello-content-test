      ...
      *PROGRAMA: ALTERA A SEQUENCIA DO BANCO DO BRASIL (CEVAN)
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           IF ST-SEQ <> "00"
              MOVE "ERRO ABERTURA SEQBRA7 "  TO CAP002-MENSAGEM-ERRO
