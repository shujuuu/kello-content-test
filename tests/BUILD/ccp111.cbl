      ...
      *FUNÇÃO: Conferência de creditos de reportagem, e atualização
      *        no contas correntes
      ...
      *    SELECIONADA
           ...
           05  MASC-QTDE             PIC ZZZZZZ   VALUE ZEROS.
      ...
      *    MOVE 1 TO COD-USUARIO-W.
       ...
       GRAVA-WORK SECTION.
           ...
           INITIALIZE REG-CCD110
                      GS-TOTAL-PESSOAS
           MOVE GS-MESANO-BASE(1: 2) TO MESANO-BASE-CC110(5: 2)
           MOVE GS-MESANO-BASE(3: 4) TO MESANO-BASE-CC110(1: 4)
           MOVE MESANO-BASE-CC110    TO MESANO-I
           ...
           PERFORM UNTIL ST-CCD110 = "10"
             READ CCD110 NEXT RECORD AT END
                  MOVE "10" TO ST-CCD110
             NOT AT END
                  MOVE CODIGO-CC110    TO GS-EXIBE-CODIGO
                  MOVE "TELA-AGUARDA1" TO DS-PROCEDURE
                  PERFORM CALL-DIALOG-SYSTEM
                  IF MESANO-BASE-CC110 NOT = MESANO-I
                     MOVE "10" TO ST-CCD110
                  ELSE
                     IF ATUALIZADO-CC-CC110 = 0
                        ADD 1                    TO GS-TOTAL-PESSOAS
                        MOVE CODIGO-CC110        TO CODIGO-WK
                                                    CODIGO-CG01
                        ...
                        READ WORK INVALID KEY
                             MOVE VALOR-CREDITO-CC110 TO VALOR-WK
                             WRITE REG-WORK
                             END-WRITE
                        NOT INVALID KEY
                             ADD VALOR-CREDITO-CC110 TO VALOR-WK
                             REWRITE REG-WORK
                             END-REWRITE
                        END-READ
                     END-IF
                    ...
                    IF ATUALIZADO-CC-CC110 = 0
                       ...
                       PERFORM UNTIL ST-CCD100 = "10"
                            WRITE REG-CCD100 INVALID KEY
                                  ...
                                  MOVE SEQ-CC101 TO SEQ-CC100
                            NOT INVALID KEY
                                  MOVE 1 TO ATUALIZADO-CC-CC110
                                  REWRITE REG-CCD110
                                  END-REWRITE
                                  MOVE "10" TO ST-CCD100
                            END-WRITE
                       END-PERFORM
                       PERFORM ATUALIZA-REPORTAGEM
                    END-IF
                 END-IF
             END-READ
           END-PERFORM.
       ...
       ATUALIZA-SEQ-CCD101 SECTION.
           ...
           NOT INVALID KEY
                ...
                END-REWRITE
           END-READ.
       ATUALIZA-REPORTAGEM SECTION.
           MOVE DOCTO-CC110(1: 6)  TO DOCTO-R100.
           READ RED100 NOT INVALID KEY
                MOVE 1 TO LCTO-CTA-CORR-R100
                REWRITE REG-RED100
                END-REWRITE
           END-READ.
       ...
       IMPRIME-RELATORIO SECTION.
           ...
           END-PERFORM.
           MOVE SPACES TO LINDET-REL
           MOVE "Totalizador => "       TO LINDET-REL
           MOVE "N. Pessoas => "        TO LINDET-REL(20:14)
           MOVE GS-TOTAL-PESSOAS        TO MASC-QTDE
           MOVE MASC-QTDE               TO LINDET-REL(35:06)
           MOVE GS-TOTAL-CREDITO        TO VALOR-E
           MOVE VALOR-E                 TO LINDET-REL(40:13)
