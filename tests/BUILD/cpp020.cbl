      ...
      *            END-IF
               WHEN CPP020-HABILITA-SITUACAO-TRUE
                   ...
                   READ CPD020 INVALID KEY
                       MOVE "Contas a Pagar Não Encontrado" TO MENSAGEM
                       MOVE "C" TO TIPO-MSG
                   ...
                   NOT INVALID KEY
                       ...
                       READ CAD004 INVALID KEY
                            MOVE "Usuário sem Permissão para Habilitar
      -                     "Contas a Pagar" TO MENSAGEM
                            MOVE "C" TO TIPO-MSG
                            PERFORM EXIBIR-MENSAGEM
                       NOT INVALID KEY
                            MOVE "Você Deseja Alterar a Situação do Cont
      -                     "as a Pagar ?" TO MENSAGEM
                            ...
                            IF RESP-MSG = "S"
                               ...
                               REWRITE REG-CPD020 INVALID KEY
                                   MOVE "Erro de Regravação...CPD020" TO
                                   MENSAGEM
                                   MOVE "C" TO TIPO-MSG
                                   PERFORM EXIBIR-MENSAGEM
                               END-REWRITE
      ...
      *    VERIFICA SE DATA DE MOVTO OU VENCTO < 19950101
       ...
       ERRO-GRAVACAO SECTION.
           MOVE "ERRO GRAVAÇÃO" TO CPP020-MENSAGEM-ERRO(1:14)
           PERFORM LOAD-SCREENSET
           PERFORM CARREGA-MENSAGEM-ERRO.
