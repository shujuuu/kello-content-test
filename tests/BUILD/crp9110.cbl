      ...
      *EMISSÃO DE RELATÓRIO DE RETORNO DO BRADESCO
      ...
      *LISTAR OS PROBLEMAS P/ QUE O USUÁRIO POSSA ACERTÁ-LO MANUALMENTE.
       ...
       01  CAB01.
           05  FILLER               PIC X(85)  VALUE
               'RELOTORIO DE RETORNO - BRADESCO'.
           05  FILLER               PIC X(07)  VALUE 'EMIS.:'.
           05  EMISSAO-REL          PIC 99/99/99.
       01  CAB01A.
           05  FILLER               PIC X(85)  VALUE
               'RELATORIO DE PROBLEMAS NA ATUALIZACAO - BRADESCO'.
           05  FILLER               PIC X(07)  VALUE 'EMIS.:'.
      ...
      *        NR-TITULO-T1 NOT = SPACES - TRATA-SE DE CONTAS A RECEBER
                            ...
                            MOVE MOTIVO-REJEIC-T1  TO GS-LINDET(95: 2)
       ...
       ATUALIZA-A-RECEBER SECTION.
           ...
           PERFORM UNTIL ST-RET = "10"
                ...
                NOT AT END
                     ...
                     MOVE DADOS-RET TO RET-TIPO1
                     IF ID-REG-RET = 0 OR
                        OCORRENCIA-T1 <> 06 AND OCORRENCIA-T1 <> 03 AND
                        OCORRENCIA-T1 <> 02
                        OR NR-TITULO-T1 = SPACES
                           PERFORM TITULOS-NAO-ENCONTRADO
                           CONTINUE
      *     ocorrencia = 02-aceito pelo banco
      *                  06-baixa              03-entrada rejeitada
                     ELSE
                        IF ID-REG-RET = 9
                           CLOSE RETORNO
                           OPEN INPUT RETORNO
      ...
      *             não faz parte do layout novo = cod-compl+seq
                           ELSE
                              MOVE NR-CONTR-T1(2: 9)
                                TO COD-COMPL-CR20
                              MOVE NR-CONTR-T1(10: 5)
                                TO SEQ-CR20
      ...
      *    procura o título através da chave vencto, docto e valor
           ...
           MOVE MES-W         TO MES-I
           MOVE ANO-W         TO ANO-I
           MOVE DATA-I        TO DATA-VENCTO-CR20(3: 6)
                                 DATA-VENCTO(3: 6)
           IF ANO-I > 90
           ...
           PERFORM UNTIL ST-CRD020 = "10"
                 ...
                 END-READ
           END-PERFORM.
           IF NAO-ENCONTRADO = 0 PERFORM TITULOS-NAO-ENCONTRADO.
           ...
           PERFORM UNTIL ST-PROBLEMA = "10"
               ...
               NOT AT END
                    ...
                    ELSE
                       ...
                       MOVE MOTIVO-REJEIC-T1       TO GS-LINDET1(95: 2)
      ...
      *--------------------------------------------------------------
       ...
       FINALIZAR-PROGRAMA SECTION.
           CLOSE CRD020 RETORNO PROBLEMA CRD020B
