      ...
      *DATA: 24/05/2000
      *DESCRIÇÃO: CADASTRO DE OPERAÇÕES - LABORATÓRIO
      ...
      *    ou alfabético
       ...
       INICIALIZA-PROGRAMA SECTION.
           ...
           MOVE 1 TO GRAVA-W.
           IF ST-LBD028 = "35"
              CLOSE LBD028      OPEN OUTPUT LBD028
              CLOSE LBD028      OPEN I-O LBD028
           END-IF.
           IF ST-LBD028 <> "00"
       ...
       CARREGAR-DADOS SECTION.
           ...
           MOVE GS-CODIGO       TO CODIGO-LB28.
           READ LBD028 INVALID KEY INITIALIZE REG-LBD028
                                   MOVE 1 TO GRAVA-W.
       ...
       SALVAR-DADOS SECTION.
           MOVE GS-CODIGO       TO CODIGO-LB28.
           MOVE GS-DESCRICAO    TO DESCRICAO-LB28.
           IF GRAVA-W = 1
              WRITE REG-LBD028 INVALID KEY
                   PERFORM ERRO-GRAVACAO
           ELSE REWRITE REG-LBD028 INVALID KEY
                PERFORM ERRO-GRAVACAO
               NOT INVALID KEY
       ...
       ERRO-GRAVACAO SECTION.
           ...
           MOVE ST-LBD028       TO GS-MENSAGEM-ERRO(23: 2)
           PERFORM LOAD-SCREENSET
           PERFORM CARREGA-MENSAGEM-ERRO
           PERFORM ACHAR-CODIGO
           SUBTRACT 1 FROM ULT-CODIGO.
       CARREGA-ULTIMOS SECTION.
           ...
           ELSE
             MOVE ZEROS TO CODIGO-LB28
               START LBD028 KEY IS NOT < CODIGO-LB28
                 INVALID KEY MOVE "10" TO ST-LBD028.
           ...
           PERFORM UNTIL ST-LBD028 = "10"
              ...
              NOT AT END
                ADD 1 TO GS-CONT
                MOVE SPACES TO GS-LINDET
                MOVE CODIGO-LB28          TO GS-LINDET(01: 06)
                MOVE DESCRICAO-LB28       TO GS-LINDET(07: 31)
       ...
       IMPRIME-RELATORIO SECTION.
           ...
           ELSE MOVE SPACES TO DESCRICAO-LB28
                START LBD028 KEY IS NOT < DESCRICAO-LB28 INVALID KEY
                           MOVE "10" TO ST-LBD028.
             ...
             READ LBD028 NEXT RECORD AT END MOVE "10" TO ST-LBD028
              NOT AT END
               MOVE SPACES TO LINDET-REL
                MOVE CODIGO-LB28              TO LINDET-REL(01: 06)
                MOVE DESCRICAO-LB28           TO LINDET-REL(07: 31)
       ...
       ACHAR-CODIGO SECTION.
           MOVE ZEROS TO ULT-CODIGO ST-LBD028.
           PERFORM UNTIL ST-LBD028 = "10"
             ADD 1 TO ULT-CODIGO
             MOVE ULT-CODIGO TO CODIGO-LB28
             READ LBD028 INVALID KEY MOVE "10" TO ST-LBD028
