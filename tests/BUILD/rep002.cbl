      ...
      *DATA: 24/02/2000
      *DESCRIÇÃO: Cadastro de FUNÇÕES - CONTROLE DE REPORTAGEM
      ...
      *            MOVE SPACES TO GS-LINDET
                   ...
                   EVALUATE ACUMULAR-RE02
                      WHEN 1 MOVE "1-Coordenação"   TO GS-LINDET(32:20)
                      ...
                      WHEN 6 MOVE "6-Locação KM"    TO GS-LINDET(32:20)
       ...
       IMPRIME-RELATORIO SECTION.
           ...
           PERFORM UNTIL ST-RED002 = "10"
                ...
                NOT AT END
                     ...
                     EVALUATE ACUMULAR-RE02
                        WHEN 1 MOVE "1-Coordenação" TO LINDET-REL(32:20)
                        ...
                        WHEN 6 MOVE "6-Locação KM"  TO LINDET-REL(32:20)
